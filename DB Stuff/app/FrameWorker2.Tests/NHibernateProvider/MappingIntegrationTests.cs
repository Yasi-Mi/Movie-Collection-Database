using System.IO;
using MovieDatabase.NHibernateProvider;
using NHibernate;
using NHibernate.Cfg;
using NHibernate.Tool.hbm2ddl;
using NUnit.Framework;

namespace MovieDatabase.Tests.NHibernateProvider
{
    /// <summary>
    ...
    public class MappingIntegrationTests
    {
        ...
        public void CanGenerateDatabaseSchema() {
            using (ISession session = _sessionFactory.OpenSession()) {
                using (TextWriter stringWriter = new StreamWriter("../../../../app/MovieDatabase.DB/Schema/UnitTestGeneratedSchema.sql")) {
